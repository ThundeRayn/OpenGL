...
class Scene:
    ...
    def update(self,rate):
        ...
        for light in self.lights:
            light.position[0] = 150 * math.sin(self.theta)
            light.position[1] = 100
            light.position[2] = 150 * math.cos(self.theta)
...
class GraphicsEngine:
    ...
    def __init__(self):
        ...
        #shaders
        self.shader = self.createShader("shaders/a3_3_pr_v.txt", "shaders/a3_3_pr_f.txt")
