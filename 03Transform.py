...
class App:
    def __init__(self):
        ...
        self.cube = Cube(
            position = [0,0,-5], #z=0 is in line of screen, -z (in front of the camera)
        ...
        projection_transform=pyrr.matrix44.create_perspective_projection(
            ...
            near=0.1, far=10, dtype=np.float32 #anything z<0.1,z>10 won't be draw, 
        )
        glUniformMatrix4fv( 
...
class CubeMesh:
    ...
    def __init__(self):
        # x, y, z, s, t(st is for texture pos)
        self.vertices = (
                -0.5, -0.5, -0.5, 0, 0,
                 0.5, -0.5, -0.5, 1, 0,
                 0.5,  0.5, -0.5, 1, 1,#a triangle mesh of the cube
        ...
        glVertexAttribPointer(0,3,GL_FLOAT,GL_FALSE,20,ctypes.c_void_p(0))#how it lays out in vbo
        #texture
